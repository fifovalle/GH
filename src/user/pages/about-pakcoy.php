      ...
      <div class="row">
        <div class="col-lg-8 offset-lg-2 text-center">
          <div class="breadcrumb-text">
            ...
            <h1>Si Sayur Hijau Berkhasiat</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-5">
          <div class="single-product-img">
            <img src="../assets/img/produk/pakcoy.png" alt="" />
          </div>
        </div>
        <div class="col-md-7">
          <div class="single-product-content">
            ...
            <p>
              Pakcoy, atau juga dikenal sebagai bok choy atau sawi pakcoy,
              adalah salah satu jenis sayuran yang berasal dari keluarga
              Brassicaceae, yang juga mencakup kubis, brokoli, dan kailan.
              Sayuran ini memiliki daun hijau gelap yang lebar dan tangkai
              putih yang tebal. Pakcoy sering digunakan dalam masakan Asia,
              terutama dalam masakan Tiongkok dan masakan Asia Tenggara,
              karena memiliki tekstur yang renyah dan rasa yang lembut.
            </p>
