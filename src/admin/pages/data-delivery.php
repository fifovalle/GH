            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data Pengiriman</span></h4>
                        <div class="table-responsive text-nowrap">
                            <table class="table card-table">
                                <div class="justify-content-end d-flex">
                                    <button class="btn btn-primary me-4 mb-3" data-bs-toggle="modal" data-bs-target="#tambahPengiriman">Tambah Pengiriman</button>
                                </div>
                                <thead>
                                    <tr>
                                        <th>No</th>
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    <?php else : ?>
                                        <tr>
                                            <td colspan="9" class="text-center text-danger fw-bold">Tidak ada data pengiriman!</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
