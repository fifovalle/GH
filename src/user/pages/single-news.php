        ...
        <div class="col-lg-8">
          <div class="single-article-section">
              ...
              <div class="comment-list">
                ...
                <div class="single-comment-body">
                  ...
                  <div class="comment-text-body">
                    <h4>
                      Pengguna 3
                      <span class="comment-date">May 12, 2020</span>
                      <a href="#">balas</a>
                    </h4>
                    <p>
                      Nunc risus ex, tempus quis purus ac, tempor consequat
            ...
            <div class="comment-template">
              ...
              <p>
                Jika Anda memiliki komentar jangan ragu untuk mengirimkan
                pendapat Anda kepada kami.
              </p>
              <form action="index.html">
                ...
                <p>
                  <textarea name="comment" id="comment" cols="30" rows="10" placeholder="Pesan"></textarea>
                </p>
          ...
          <div class="sidebar-section">
            <div class="recent-posts">
              ...
              <ul>
                ...
                <li>
                  <a href="single-news.html">Fall in love with the fresh orange</a>
                </li>
                <li>
                  <a href="single-news.html">Why the berries always look delecious</a>
                </li>
              </ul>
            </div>
