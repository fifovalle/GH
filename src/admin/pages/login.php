                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form action="<?php echo $akarUrl; ?>src/admin/config/login-admin.php" method="post">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="email" id="form-input" name="Email_Nama_Pengguna_Admin" class="form-control form-control-lg" placeholder="Masukan Email Anda Atau Nama Pengguna" />
                                    </div>
