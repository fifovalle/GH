      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="single-latest-news">
            <a href="../pages/berita-tunggal.html">
              <div class="latest-news-bg news-bg-1"></div>
            </a>
            <div class="news-text-box">
              <h3>
                <a href="../pages/berita-tunggal.html">Judul Berita 1.</a>
              </h3>
              <p class="blog-meta">
              ...
              <a href="../pages/berita-tunggal.html" class="read-more-btn">baca selengkapnya <i class="fas fa-angle-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6">
          <div class="single-latest-news">
            ...
            <div class="news-text-box">
              <h3>
                <a href="../pages/berita-tunggal.html">Judul Berita 2.</a>
              </h3>
              <p class="blog-meta">
                <span class="author"><i class="fas fa-user"></i> Admin</span>
                <span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
        ...
        <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
          <div class="single-latest-news">
            ...
            <div class="news-text-box">
              <h3>
                <a href="../pages/berita-tunggal.html">Judul Berita 3.</a>
              </h3>
              <p class="blog-meta">
                <span class="author"><i class="fas fa-user"></i> Admin</span>
                <span class="date"><i class="fas fa-calendar"></i> 27 December, 2019</span>
