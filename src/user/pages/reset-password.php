                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form action="../config/login-admin.php" method="post">
                                    ...
                                    <div class="form-outline mb-4 position-relative">
                                        ...
                                        <input type="password" id="reset_password" name="Ubah_Kata_Sandi_User" class="form-control form-control-lg" placeholder="Masukan Kata Sandi Baru" />
                                        <i class="fas fa-eye position-absolute" id="toggle-reset" style="right: 25px; top: 50px; cursor: pointer"></i>
                                    </div>
                                    <div class="form-outline mb-4 position-relative">
                                        <label class="form-label">Konfirmasi Kata Sandi Baru</label>
                                        <input type="password" id="confirm_password" name="Konfirmasi_Kata_Sandi_User" class="form-control form-control-lg" placeholder="Konfirmasi Kata Sandi Baru" />
