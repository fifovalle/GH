        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo $akarUrl; ?>src/admin/config/add-admin.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="tambahNamaDepanAdmin" placeholder="Masukan Nama Depan Admin" />
                        <label for="tambahNamaDepanAdmin">Nama Depan</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="tambahNamaBelakangAdmin" placeholder="Masukan Nama Belakang Admin" />
                        <label for="tambahNamaBelakangAdmin">Nama Belakang</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" id="tambahEmailAdmin" placeholder="Masukan Email Admin" />
                        <label for="tambahEmailAdmin">Email</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="tambahNamaPenggunaAdmin" placeholder="Masukan Nama Pengguna Admin" />
                        <label for="tambahNamaPenggunaAdmin">Nama Pengguna</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control" id="tambahKataSandiAdmin" placeholder="Masukan Kata Sandi Admin" />
                        <label for="tambahKataSandiAdmin">Kata Sandi</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control" id="tambahKonfirmasiKataSandiAdmin" placeholder="Masukan Konfirmasi Kata Sandi Admin" />
                        <label for="tambahKonfirmasiKataSandiAdmin">Konfirmasi Kata Sandi</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="tambahAlamatAdmin" placeholder="Masukan Alamat Admin" />
                        <label for="tambahAlamatAdmin">Alamat</label>
                    </div>
                    <div class="form-floating mb-3">
                        <select id="tambahPeranAdmin" class="form-select">
