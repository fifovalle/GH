              ...
              <div class="card-body p-4 p-lg-5 text-black">
                <form action="../config/login-user.php" method="post">
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <input type="text" id="form-input" class="form-control form-control-lg" name="Email_Nama_Pengguna" placeholder="masukan email atau nama pengguna anda" autocomplete="off" />
                  </div>
                  <div class="form-outline mb-4 position-relative">
                    <label class="form-label">Kata Sandi</label>
                    <input type="password" id="password" name="Kata_Sandi_Pengguna" class="form-control form-control-lg" placeholder="masukan kata sandi anda" />
                    <i class="fas fa-eye position-absolute" id="toggle-login" style="right: 25px; top: 50px; cursor: pointer"></i>
                  </div>
                  <div class="pt-1 mb-4 d-flex justify-content-center">
                    <button class="btn btn-lg btn-block" name="Masuk" type="submit">
                      Masuk
                    </button>
                  </div>
                  <p class="text-forgot">
                    Belum memiliki akun?
                    <a href="<?php echo $akarUrl; ?>src/user/pages/signup.php">Daftar Disini.</a>
                  </p>
                  <p class="text-forgot">
                    Lupa kata sandi?
                    <a href="<?php echo $akarUrl; ?>src/user/pages/forgot-password.php">Klik Disini.</a>
                  </p>
                </form>
              </div>
            </div>
